...
!function(e, t) {
    ...
    }, r = "WebKitCSSMatrix"in window || document.body && "MozPerspective"in document.body.style, l = "onmousedown"in window, c = (window,
    navigator.userAgent), d = e.utils = {
        drag: {
            left: 0,
            right: 1,
            none: -1
        ...
        hasCompatibility: function() {
            var e = !1;
            return null != window.dFlipLocation && window.dFlipLocation.indexOf("lip-lit") > 0 && (e = !0),
            e
        },
        scrollIntoView: function(e, t, n) {
            (t = t || e.parentNode).scrollTop = e.offsetTop - t.offsetTop + (!1 === n ? e.offsetHeight - t.offsetHeight : 0),
        ...
        httpsCorrection: function(e) {
            ...
            return t.href.indexOf("https://") > -1 && e.indexOf(t.hostname) > -1 && (e = e.replace("http://", "https://")),
            t.href.indexOf("http://") > -1 && e.indexOf(t.hostname) > -1 && (e = e.replace("https://", "http://")),
            e
        },
        ...
        getScript: function(e, n, i) {
            ...
            function s(e, t) {
                if (null != o && (t || !o.readyState || /loaded|complete/.test(o.readyState)) && (o.onload = o.onreadystatechange = null,
                o = null,
                o = null,
                !t)) {
            ...
            if (0 === t("script[src='" + e + "']").length) {
                ...
                null != r ? (r.parentNode.insertBefore(o, r),
                r = null) : document.body.appendChild(o),
        ...
        isHardPage: function(e, t, n, i) {
            if (null != e) {
                if ("cover" == e)
                    return 0 == t || i && 1 == t || t == Math.ceil(n / (i ? 1 : 2)) - (i ? 0 : 1);
                if ("all" == e)
                    return !0;
        ...
        i = Array.prototype.slice.call(n).join("").match(/-(moz|webkit|ms)-/)[1],
        {
    ...
    }, u = e.SOURCE_TYPE, h = (e.DISPLAY_TYPE,
    d.drag), p = d.mouseEvents, g = d.html, f = d.isset, m = (d.isnull,
    d.toRad), v = d.toDeg, b = (d.transition,
    d.translateStr), w = (d.resetBoxShadow,
    d.rotateStr), P = (d.bg,
    d.bgImage), x = (d.src,
    d.limitAt), y = d.distOrigin, C = d.distPoints, L = d.angleByDistance, S = d.log, E = d.nearestPowerOfTwo, I = d.extendOptions, k = d.getBasePage, T = d.getScript, O = d.fixMouseEvent, R = d.prefix, F = d.isBookletMode, M = d.isRTLMode, D = d.isMobile, N = d.hasWebgl, z = d.isSafari, A = d.isIOS, B = d.__extends;
    !function() {
        if (window.CanvasPixelArray)
            ...
            var e, t = !1;
            if (z && (t = (e = c.match(/Version\/([0-9]+)\.([0-9]+)\.([0-9]+) Safari\//)) && parseInt(e[1]) < 6),
            t) {
    ...
    var _ = function(n, i) {
        ...
        s.dispose = function() {
            ...
            c.remove(),
            p.remove(),
            s.shareBox && (s.shareBox.dispose && s.shareBox.dispose(),
            s.shareBox = null),
        ...
        1 == r.autoPlay && (s.play = h,
        i.setAutoPlay(r.autoPlayStart));
        var p = t(g.div, {
        ...
        "string" == typeof r.source && 1 == r.search) {
            var x = s.search = t(g.div, {
                ...
                x.hasClass("df-active") || (t(this).addClass("df-active"),
                e.stopPropagation())
            }
            ));
        ...
        var C = s.more = t(g.div, {
            ...
            C.hasClass("df-active") || (t(this).addClass("df-active"),
            e.stopPropagation())
        }
        ));
        function L(e) {
        ...
        if (C.append(E),
        "string" == typeof r.source && 1 == r.enableDownload) {
        ...
        s.switchFullscreen = function() {
            ...
            var e = i.container[0];
            1 != s.isFullscreen ? (i.container.addClass("df-fullscreen"),
            e.requestFullscreen ? e.requestFullscreen() : e.msRequestFullscreen ? e.msRequestFullscreen() : e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.webkitRequestFullscreen && e.webkitRequestFullscreen(),
            s.isFullscreen = !0) : (i.container.removeClass("df-fullscreen"),
            s.isFullscreen = !1,
            document.exitFullscreen ? document.fullscreenElement && document.exitFullscreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.mozCancelFullScreen ? document.fullscreenElement && document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen()),
            d.hasFullscreenEnabled() || setTimeout((function() {
                i.resize()
            }
            ), 50)
        }
        ...
        var O = t(g.div, {
          ...
          , R = (s.shareBox = new e.Share(n,r),
        s.share = t(g.div, {
            class: "df-ui-btn df-ui-share " + r.icons.share,
            title: r.text.share,
            html: "<span>" + r.text.share + "</span>"
        }).on("click", (function(e) {
            1 == s.shareBox.isOpen ? s.shareBox.close() : (s.shareBox.update(i.getURLHash()),
            s.shareBox.show())
        }
        )))
    ...
    function U() {
        j = function(e) {
            function n(n) {
                ...
                i.dispose = function() {
                    ...
                    1 == i.options.scrollWheel && (i.container[0].removeEventListener("mousewheel", m, !1),
                ...
                var m = function(e) {
                  ...
                  , v = function(e) {
                    ...
                    null != e.touches && 2 == e.touches.length && null != i.startTouches) {
                        ...
                        t.x,
                        t.y;
                        return i.camera.position.z = i.originalZ / n,
                        i.lastScale = n,
                        i.lastZoomCenter = t,
                    ...
                    if (1 == i.isMouseDown && 1 == i.previewObject.contentProvider.zoomScale) {
                        ...
                        performance.now(),
                        i.lastTime;
                        Math.abs(o) > i.swipe_threshold && (o < 0 ? i.target.next() : i.target.prev(),
                        e.preventDefault(),
                        i.isMouseDown = !1),
                        i.lastPos = e.pageX,
                  ...
                  , b = function(e) {
                    null != (e = O(e)).touches && 2 == e.touches.length && null == i.startTouches && (i.startTouches = d.getTouches(e),
                    i.lastScale = 1,
                  ...
                  , w = function(e) {
                    if (null != (e = O(e)).touches && 0 == e.touches.length) {
                        i.previewObject.contentProvider.zoomScale;
                        1 == i.zoomDirty && (i.previewObject.contentProvider.zoomScale = d.limitAt(i.previewObject.contentProvider.zoomScale * i.lastScale, 1, i.previewObject.contentProvider.maxZoom),
                ...
                return i.renderer.domElement.addEventListener("mousemove", v, !1),
                ...
                1 == i.options.scrollWheel && (i.container[0].addEventListener("mousewheel", m, !1),
        ...
        var n = function(t) {
            ...
            n.prototype.tween = function(t, n) {
                ...
                i.isFlipping = !0;
                s && (!l && !c || l && c) && (i.material.materials[5].opacity = i.material.materials[4].opacity = 0,
                i.castShadow = !1),
                i.currentTween = new TWEEN.Tween(i.init).to({
                    ...
                    1 == i.isHard ? i.stiffness = 0 : (i.stiffness = t.stiff / (a + o) * (i.newStiffness + o),
                    i.stiffness = isNaN(i.stiffness) ? 0 : t.stiff),
                    s && (i.material.materials[5].opacity = i.material.materials[4].opacity = t.index,
                    i.castShadow = t.index > .5),
                    i.updateAngle(!0)
                }
        ...
        var i = function(t) {
            ...
            n.prototype.moveBy = function(e) {
                ...
                1 != this.firstFlipped && (this.previewObject.analytics({
            ...
            n.prototype.updatePage = function(t) {
                ...
                this.children.unshift(this.children.pop())) : a < t && (this.children[0].skipFlip = !0,
                this.children.push(this.children.shift()));
                for (var g = 5 / r, f = g * t / 2, m = g * (r - t) / 2, v = f < m ? m : f, b = 0; b < l; b++) {
                    var w, P = this.children[b], x = (P.color,
                    P.angles[1]), y = t - h + b;
                    n && (y = i ? this.pageCount - y : Math.ceil(this.pageCount / 2) - y - 1);
                    var C = P.isHard = this.isPageHard(y)
                      , L = P.name;
                    P.isEdge = !1,
                    0 == b ? P.depth = f < d ? d : f : b == l - 1 ? P.depth = m < d ? d : m : (P.depth = d,
                    P.isEdge = !1),
                    1 == P.isFlipping && (P.depth = d),
                    P.position.x = 0;
                    var S = c * b
                      , E = 180 - c * (b - h) + c * b;
                    if (b < h ? (P.newStiffness = C || 0 == this.stiffness ? 0 : u / (t / r) / 4,
                    w = S,
                    P.position.z = v - (-b + h) * d,
                    1 == p && (P.position.z -= d)) : (w = E,
                    ...
                    0 == P.isFlipping)
                        if (Math.abs(x - w) > 20 && 0 == P.skipFlip) {
                            ...
                            P.angles[1] == w && P.stiffness == P.newStiffness && P.depth == P.oldDepth || (P.angles[1] = P.angles[4] = w,
                            P.stiffness = P.newStiffness,
                            P.updateAngle(!0));
                    P.visible = i ? n ? b < h || P.isFlipping : b >= h || P.isFlipping : y >= 0 && y < r || i && y == r,
                    null != this.requestPage && (P.name = y.toString(),
                    P.name != L && (P.textureLoaded = !1,
    ...
    var H = function(n) {
        function i(t) {
            ...
            this.dispose = function() {
                ...
                this.zoomTween = null),
                this.container && (this.container.removeClass && this.container.removeClass("df-sidemenu-open df-floating"),
        ...
        return i.prototype = {
            ...
            resize: function() {
                ...
                if (null != n.target && null != n.target.ui && null != n.target.contentProvider && null != n.target.contentProvider.viewport && null != n.target.stage) {
                    ...
                    var i, o, a, s, r, l, c = n.target, h = n.container, p = n.options, g = c.stage, f = c.contentProvider, m = f.pageRatio, v = (f.zoomViewport,
                    M(c)), b = "css" !== c.mode, w = (f.pageRatio,
                    1 != this.ui.isFullscreen && "auto" === p.height), P = h.hasClass("df-sidemenu-open") ? 220 : 0, C = this.target.pageMode == e.PAGE_MODE.SINGLE;
                    ...
                    var S = h.find(".df-ui-controls").height()
                      ...
                      , T = p.paddingLeft
                      , O = (E = isNaN(E) ? 0 : x(E, 0, E)) + (k = isNaN(k) ? 0 : x(k, 0, k))
                      , R = (T = isNaN(T) ? 0 : x(T, 0, T)) + (I = isNaN(I) ? 0 : x(I, 0, I))
                      , F = L - P;
                    h.height(p.height);
                    var D = t(window).height()
                      , N = Math.min(h.height(), D)
                      , z = n.calculateSize(N, F, D, O, R, w, m, C);
                    N = A = w ? n.calculateSize(N, F + P, D, O, R, w, m, C).stageHeight : z.stageHeight,
                    h.height(N);
                    var A = N
                      , B = F - R
                      , _ = A - O;
                    if (a = Math.floor(C ? B : B / 2),
                    ...
                    f.contentSourceType == u.PDF && (a = f.imageViewport.width / r,
                    ...
                    if (b) {
                        ...
                        g.resizeCanvas(F, A),
                        s = 1 / (2 * Math.tan(Math.PI * g.camera.fov * .5 / 180) / (V / r)) + 2.2,
                        g.camera.updateProjectionMatrix(),
                        g.renderRequestPending = !0;
                        var G = (E - k) * (c.height / o) / r / 2
                          , q = 1 == f.zoomScale;
                        g.camera.position.z !== s && 1 == n.pendingZoom ? (null != n.zoomTween && n.zoomTween.stop(),
                        ...
                        c.stage.find(".df-book-page, .df-page-front , .df-page-back, .df-page-fold-inner-shadow").height(U).width(j)
                    }
                    n.checkCenter({
                        type: "resize"
                    }),
            ...
            checkCenter: function(t) {
                ...
                var n, i = this.target, o = 0, a = 0, s = 0, r = d.getBasePage(i._activePage), l = i._activePage % 2 == 0, c = i.direction == e.DIRECTION.RTL, u = i.pageMode == e.PAGE_MODE.SINGLE, h = u && i.singlePageMode == e.SINGLE_PAGE_MODE.BOOKLET, p = i.stage.width();
                if ("css" == i.mode)
                    n = i.wrapper.width(),
                    o = Math.max((n - p) / 2, 0),
                    a = -n / 4,
                    ...
                    a = -(n = i.width) / 2,
                    s = n / 2,
                    (g = 0 == r || h ? c ? s : a : r == i.pageCount ? c ? a : s : u ? c ? l ? a : s : l ? s : a : 0) !== this.centerEnd && (this.centerTween = new TWEEN.Tween({
                        x: f
                    }).delay(0).to({
                        x: g
    ...
    var W = function(n) {
        function i(n, i, o, a) {
            o = o || {};
            var r = this;
            if (r.contentRawSource = n || [s.textureLoadFallback],
            ...
            Array === r.contentSource.constructor || Array.isArray(r.contentSource) || r.contentSource instanceof Array) {
                ...
                t("<img/>").attr("src", r.contentSource[0]).on("load", (function() {
                    ...
                    t(this).off(),
                    r.options.pageSize == e.PAGE_SIZE.DOUBLEINTERNAL && (r.pageCount = 2 * r.contentSource.length - 2,
                ...
                var c = function() {
                            ...
                            t.getPage(1).then((function(n) {
                                ...
                                t.numPages > 1 ? t.getPage(2).then((function(n) {
                                    if (r.options.pageSize == e.PAGE_SIZE.AUTO) {
                                        ...
                                        o.width / o.height > 1.5 * r.pageRatio ? (r.options.pageSize = e.PAGE_SIZE.DOUBLEINTERNAL,
                                        r.pageCount = 2 * t.numPages - 2) : r.options.pageSize = e.PAGE_SIZE.SINGLE
                                    }
                                    null != i && (i(r),
                                    i = null)
                                }
                  ...
                  , p = function() {
                    if (r) {
                        ...
                        n.hostname !== window.location.hostname ? (r.updateInfo(r.options.text.loading + " PDF Worker CORS ..."),
                        t.ajax({
                            url: s.pdfjsWorkerSrc,
                            cache: !0,
                            success: function(t) {
                                s.pdfjsWorkerSrc = e.createObjectURL(t, "text/javascript"),
                                c()
                            }
                        })) : c()
                    }
                };
                null == window.pdfjsLib ? r && (r.updateInfo(r.options.text.loading + " PDF Service ..."),
                T(s.pdfjsSrc + "?ver=" + e.version, (function() {
                    "function" == typeof define && define.amd && window.requirejs ? (r.updateInfo(r.options.text.loading + " PDF Service (require) ..."),
                    require.config({
                        paths: {
                    ...
                    ))) : "object" == typeof exports && null != exports["pdfjs-dist/build/pdf"] ? (window.pdfjsLib = exports["pdfjs-dist/build/pdf"],
                    p()) : p()
                }
                ), (function() {
            ...
            return this.dispose = function() {
                ...
                r.loading = null,
                r.textureLoadTimeOut && (clearTimeout(r.textureLoadTimeOut),
                r.textureLoadTimeOut = null),
        ...
        i.prototype.initThumbs = function() {
            ...
            var i = function() {
              ...
              , o = function() {
                ...
                0 == o && clearTimeout(e)),
                o > 0 && i(),
                n.activeThumb != n.targetObject._activePage) && (null != n.targetObject.thumbContainer && n.targetObject.thumbContainer.hasClass("df-sidemenu-visible"))) {
                    var a = n.thumblist.container
                      , s = a.scrollTop
                      , r = a.getBoundingClientRect().height
                      , l = n.targetObject.thumbContainer.find("#df-thumb" + n.targetObject._activePage);
                    l.length > 0 ? (n.targetObject.thumbContainer.find(".df-selected").removeClass("df-selected"),
                    l.addClass("df-selected"),
                    s + r < (l = l[0]).offsetTop + l.scrollHeight ? d.scrollIntoView(l, null, !1) : s > l.offsetTop && d.scrollIntoView(l),
                    n.activeThumb = n.targetObject._activePage) : (t(a).scrollTop(124 * n.targetObject._activePage),
                    i())
                }
            };
        ...
        i.prototype.initOutline = function() {
            ...
            function a(t) {
                if (1 == e.options.overwritePDFOutline && (t = []),
                t = t || [],
                e.outline)
                    for (var n = 0; n < e.outline.length; n++)
                        e.outline[n].custom = !0,
                        t && t.push(e.outline[n]);
                0 === t.length && null != e.targetObject.ui.outline ? e.targetObject.ui.outline.hide() : 1 == e.options.autoEnableOutline && e.targetObject.ui.outline.trigger("click"),
        ...
        i.prototype.checkViewportSize = function(e, t, n) {
            ...
            if (i.contentSourceType == u.PDF) {
                if (i.cacheIndex = Math.ceil(Math.max(a, r)),
        ...
        i.prototype.getPage = function(n, i, o) {
            var a = this
              , r = n = parseInt(n, 10)
              , l = a.contentSource;
            n <= 0 && n >= a.pageCount ? a.setPage(n, s.textureLoadFallback, i, o) : a.contentSourceType == u.PDF ? null != a.getCache(n, o) ? (a.setPage(n, a.getCache(n, o), i, o),
            S("Page " + n + " loaded from cache")) : (!0 !== o && a.setLoading(n, !0),
            ...
            l.getPage(r, o).then((function(t) {
                !function(t, n, i, o) {
                    ...
                    "css" == a.targetObject.mode && Math.abs(a.targetObject.zoomHeight - u.height) < 2 && (u.height = a.targetObject.zoomHeight + 0,
                    ...
                    t.render(f).promise.then((function() {
                        S(performance.now() - h),
                        h = performance.now(),
                        1 == o || 1 == a.options.canvasToBlob && !0 !== a.webgl ? u.toBlob((function(t) {
                            var s = e.createObjectURL(t, "image/jpeg");
                            S(performance.now() - h),
                            a.setCache(n, s, o, p),
                            a.setPage(n, s, i, o)
                        }
                        ), "image/jpeg", a.pdfRenderQuality) : (S("Setting Page " + n),
                        a.setPage(n, u, i, o)),
                        f = null
                    }
                    ))
            ...
            ))) : a.contentSourceType != u.IMAGE && a.contentSourceType != u.HTML || (null != a.getCache(n, o) ? (a.setPage(n, a.getCache(n, o), i, o),
            S("Page " + n + " loaded from cache")) : (!0 !== o && a.setLoading(n, !0),
            a.options.pageSize == e.PAGE_SIZE.DOUBLEINTERNAL && n > 2 && (r = Math.ceil((n - 1) / 2) + 1),
            function(e, n, i) {
        ...
        i.prototype.setLoading = function(e, n) {
            if (null != this.targetObject)
                if (1 == this.webgl) {
                    ...
                    i.isLoading = !0,
                    S("Loading icon at " + e + " as " + n)) : null != i.isLoading && (i.removeClass("df-loading"),
                    i.isLoading = null,
                ...
                n > 0 && n <= i.pageCount) {
                    ...
                    if (null != i.links && null != i.links[n])
                        for (var l = i.links[n], c = 0; c < l.length; c++) {
                            var d, h = l[c];
                            h.dest && h.dest.indexOf && 0 == h.dest.indexOf("[html]") ? ((d = document.createElement("div")).innerHTML = h.dest.substr(6),
                            d.className = "customHtmlAnnotation") : ((d = document.createElement("a")).setAttribute("dest", h.dest),
        ...
        i.prototype.setPage = function(e, t, n, i) {
            ...
            if (1 == i) {
                ...
                null != c ? e % 2 != 0 && !r || e % 2 != 1 && r && !l || l && !r ? (S(e + "rendered to back of " + c.color),
                c.backImage(t, (function(t, i) {
                    c.backTextureLoaded = !0,
                    o.setLoading(e),
                    o.requiresImageTextureScaling && i && 1 != e && e != o.pageCount && (i.repeat.x = .5,
                    i.offset.x = .5),
                    null != n && n()
                }
            ...
            if (null != o && 0 != t(o).length) {
                ...
                return n.getAnnotations().then((function(c) {
                    ...
                    null != o) {
                        ...
                        if (d.empty(),
                        r.options.pageSize == e.PAGE_SIZE.DOUBLEINTERNAL && a > 1 && a < r.pageCount && (!l && a % 2 == 1 || l && a % 2 == 0) ? d.css({
                            left: "-100%"
                        }) : 1 == a && d.css({
                            left: ""
                        }),
      ...
      , V = function() {
        function n(e) {
            ...
            this.canvasMode = e.contentSourceType !== u.IMAGE && 0 == e.canvasToBlob,
            this.initDOM()
        }
        function i(e) {
        ...
        return n.prototype = {
            ...
            updatePoint: function(t) {
                if (null != t) {
                    ...
                    A.css({
                        transform: w(S) + b(T, O),
                        opacity: M / 2,
                        backgroundImage: R.css + "linear-gradient( " + E + "deg, rgba(0, 0, 0, 0.25) , rgb(0, 0, 0) " + .7 * g + "px, rgb(255, 255, 255) " + g + "px)"
                    }),
                    z.css({
                        opacity: M / 2,
                        left: r ? "auto" : 0,
                        right: r ? 0 : "auto",
                        backgroundImage: R.css + "linear-gradient( " + (180 - E) + "deg, rgba(0, 0, 0,0) " + g / 3 + "px, rgb(0, 0, 0) " + g + "px)"
                    })
                }
            },
            ...
            tween: function(t) {
                ...
                if (null != n && null != n.parent) {
                    var i, o = F(n.parent), a = n.side == h.right, s = n.parent.direction == e.DIRECTION.RTL, r = n.parent.corner == e.CORNERS.BL || n.parent.corner == e.CORNERS.BR, l = 1 == n.magnetic, c = r ? n.parent.height : 0, d = 0, u = n.end = n && 1 == n.animateToReset ? {
                    ...
                    1 == n.isHard ? (null != t && (d = L(t.distance, t.fullWidth)),
                    i = n.init = {
                        angle: d * (a ? -1 : 1)
                    },
                    ...
                    var g = function(e) {
                        ...
                        n.x = e.x,
                        n.y = e.y),
                        o && !l && (n.element[0].style.opacity = a && !s || !a && s ? e.index > .5 ? 2 * (1 - e.index) : 1 : e.index < .5 ? 2 * e.index : 1)
                    };
            ...
            frontImage: function(e, n) {
                ...
                1 == i.canvasMode ? (i.front.find(">canvas").remove(),
                e !== s.textureLoadFallback && i.front.append(t(e)),
                null != n && n()) : e == s.textureLoadFallback ? o() : (i.frontIMG.onload = o,
                i.frontIMG.src = e)
            },
            backImage: function(e, n) {
                ...
                1 == i.canvasMode ? (i.back.find(">canvas").remove(),
                e !== s.textureLoadFallback && i.back.append(t(e)),
                null != n && n()) : e == s.textureLoadFallback ? o() : (i.backIMG.onload = o,
                i.backIMG.src = e)
            },
      ...
      , G = function(n) {
        ...
        function o(n, o) {
            var a = this;
            function s(e) {
                a.dragPage != e.page && 1 == e.page.visible && (a.dragPage.clearTween(!0),
                a.dragPage = e.page,
                a.corner = e.corner,
            ...
            var l = function(t) {
                ...
                if (!(null != t.touches && t.touches.length > 1 || null == a.startPoint || null != a.startTouches)) {
                    ...
                    if (1 !== a.contentProvider.zoomScale)
                        null == t.touches && 1 != a.isPanning || (a.pan(n),
                        t.preventDefault());
                    else if (!0 !== a.skipDrag) {
                        n.distance;
                        if (!i(a)) {
                            if (null != a.dragPage || 1 == n.isInside) {
                                null != a.dragPage ? S("set mouse down move") : (n.y = x(n.y, 1, a.height - 1),
                            ...
                            if (null == a.dragPage && null != r && 0 == n.isInside && 1 == r.magnetic && (r.pendingPoint = n,
                            r.animateToReset = !0,
                            ...
                            1 == a.isPanning && null == a.dragPage && 1 == a.contentProvider.zoomScale) {
                                ...
                                performance.now(),
                                a.lastTime;
                                Math.abs(p) > a.swipe_threshold && (p < 0 ? a.next() : a.prev(),
                                a.drag = h.none,
                                a.isPanning = !1,
                                t.preventDefault()),
                                a.lastPos = n.x,
              ...
              , c = function(t) {
                if (null != t.touches && 0 == t.touches.length) {
                    a.contentProvider.zoomScale;
                    1 == a.zoomDirty && (a.previewObject.contentProvider.zoomScale = d.limitAt(a.previewObject.contentProvider.zoomScale * a.lastScale, 1, a.previewObject.contentProvider.maxZoom),
                ...
                !(null != t.touches && t.touches.length > 1) && !0 !== a.skipDrag) {
                    var n = a.eventToPoint(t);
                    a.dragPage && (t.preventDefault(),
                    a.dragPage.pendingPoint = n,
                    n.x == a.startPoint.x && n.y == a.startPoint.y && 1 == n.isInside ? a.corner == e.CORNERS.BR || a.corner == e.CORNERS.TR ? (s(n),
                    !0 !== a.dragPage.isFlipping && a.next()) : a.corner != e.CORNERS.BL && a.corner != e.CORNERS.TL || (s(n),
                    !0 !== a.dragPage.isFlipping && a.prev()) : !0 !== a.dragPage.isFlipping && (n.distance > n.fullWidth / 2 ? n.x > n.fullWidth / 2 ? a.prev() : a.next() : (a.dragPage.animateToReset = !0,
                    a.animatePage(a.dragPage))),
                    a.dragPage && (a.dragPage.pendingPoint = null,
              ...
              , u = function(t) {
                ...
                a.dragPage && a.dragPage.magnetic || a.wrapper[0].contains(t.target) && 1 == a.contentProvider.zoomScale && n.x == a.startPoint.x && n.y == a.startPoint.y && n.isInsidePage && a.startPoint.page == n.page && !n.page.isFlipping && "A" !== i.nodeName && (0 == a.startPoint.page.side ? (a.corner = e.CORNERS.TL,
                a.prev(),
                a.startPoint.page = null) : (a.corner = e.CORNERS.TR,
                a.next(),
                a.startPoint.page = null),
                a.isPanning = !1)
            }
              , p = function(t) {
                if (null != t.touches && 2 == t.touches.length && null == a.startTouches && (a.startTouches = d.getTouches(t),
                a.lastScale = 1),
                !(null != t.touches && t.touches.length > 1 || null == t.touches && 0 !== t.button)) {
                    ...
                    a.lastPos = o.x,
                    a.lastTime = performance.now(),
                    !0 !== a.skipDrag && (1 != o.isInside || i(a) || (a.startPoint = o,
                    a.drag = o.drag,
                    a.dragPage = o.page,
                    a.corner = o.corner,
                    S(a.corner),
              ...
              , g = function(e) {
                ...
                if (t && (t > 0 && n < i || t < 0 && n > 1)) {
                    ...
                    if (n !== l) {
                        ...
                        null == a.dragPage && null != h && 1 == o.isInside && 1 == h.magnetic && (h.pendingPoint = o,
                        h.animateToReset = !0,
              ...
              , f = a.container[0]
              , m = a.stage[0];
            f && (m.addEventListener("mousemove", l, !1),
            ...
            1 == a.options.scrollWheel && (m.addEventListener("mousewheel", g, !1),
            ...
            this.dispose = function() {
                ...
                1 == a.options.scrollWheel && (m.removeEventListener("mousewheel", g, !1),
        ...
        o.prototype = {
            ...
            getPageByNumber: function(e) {
                for (var t, n = F(this) ? M(this) ? e + 1 : e : Math.floor((e - 1) / 2), i = 0; i < this.pages.length; i++)
            ...
            getPageSide: function(t) {
                ...
                if (null != i)
                    return F(this) ? n ? i.front : i.back : t % 2 == 0 ? n ? i.back : i.front : n ? i.front : i.back
            },
        ...
        o.prototype.eventToPoint = function(n) {
            ...
            var u, p = this.drag == h.none ? c < a ? c : s - c : this.drag == h.left ? c : s - c, g = c < a ? o[this.stackCount / 2 - 1] : o[this.stackCount / 2], f = c < this.foldSense ? h.left : c > s - this.foldSense ? h.right : h.none, m = c, v = d, b = r, w = s, P = this.foldSense, x = e.CORNERS;
            return {
        ...
        o.prototype.updatePage = function(n) {
            ...
            var r = this.oldBaseNumber || 0
              ...
              , c = this.stackCount
              , d = Math.floor(c / 2);
            r > n ? (this.children[c - 1].skipFlip = !0,
            this.children.unshift(this.children.pop())) : r < n && (this.children[0].skipFlip = !0,
            this.children.push(this.children.shift()));
            for (var u = 0; u < c; u++) {
                var p = this.children[u];
                r !== n && null != p.currentTween && p.clearTween(!0);
                var g, f = p.side, m = n - d + u;
                ...
                p.element.addClass(u < d ? "df-left-side" : "df-right-side"),
                p.side = g)),
                p.visible = o ? i ? u < d || p.isFlipping : u >= d || p.isFlipping : m >= 0 && m < l || o && m == l,
                null != this.requestPage && 1 == p.visible && (p.name = m.toString(),
                p.name != v && (p.backTextureLoaded = !1,
                p.frontTextureLoaded = !1,
                p.backPageStamp = "-1",
                p.frontPageStamp = "-1",
                p.thumbLoaded = !1,
      ...
      , q = function(n) {
        function i(i, o, a) {
            ...
            if (i.addClass("df-container df-loading df-init df-floating df-controls-" + s.options.controlsPosition),
            1 == s.options.transparent && i.addClass("df-transparent"),
            s.options.direction == e.DIRECTION.RTL && i.addClass("df-rtl"),
            s.container.info = t(g.div, {
                class: "loading-info"
            }).appendTo(s.container).html(s.options.text.loading + "..."),
            c.match(/msie\s[5-9]/i))
                return s.container.info.html("Your browser (Internet Explorer) is out of date to run DFlip Flipbook Plugin. <br><a href='http://browsehappy.com/'>Upgrade to a new one</a>").addClass("df-old-browser"),
        ...
        i.prototype.init = function(n) {
            var i, o, a = this, r = a.target, l = a.options;
            if (1 == n) {
                i = function() {
                    a.container.css({
                        minHeight: 300,
                    ...
                    a.stage = new j(I(a.options, {
                        container: a.container
                    })),
                    a.stage.previewObject = a,
                    a.contentProvider = new W(a.contentSource,(function(i) {
                        var o = {
                        ...
                        r.getContentLayer = function(t) {
                            ...
                            return k(r._activePage),
                            F(r) ? n ? i : o : t % 2 == 0 ? n ? o : i : n ? i : o
                        }
                        ,
                        r.stage = a.stage,
                        r.flipCallback = function() {
                            if (a.contentProvider) {
                                ...
                                var n, i, o = k(r._activePage), s = r.getPageByNumber(o), l = r.getPageByNumber(o + 1), c = r.parent.cssScene.divLeft, d = r.parent.cssScene.divRight;
                                r.pageMode,
                                e.PAGE_MODE.SINGLE,
                                r.direction,
                                e.DIRECTION.RTL,
                        ...
                        r.flipCallback(),
                        1 == a.options.isLightBox && a.analytics({
                ...
                ,
                null == window.MOCKUP ? (a.updateInfo(l.text.loading + " WEBGL 3D ..."),
                "function" == typeof define && define.amd && window.requirejs ? (requirejs.config({
                    paths: {
                ...
                a.contentProvider = new W(a.contentSource,(function(e) {
                    var i = {
...
function(e) {
    ...
    e.Blob = function(e, n) {
        ...
        var r = o.getBlob(i);
        return !r.slice && r.webkitSlice && (r.slice = r.webkitSlice),
        r
    }
    ;
...
function(e) {
    var t, n = e.Uint8Array, i = e.HTMLCanvasElement, o = i && i.prototype, a = /\s*;\s*base64\s*(?:;|$)/i, s = "toDataURL", r = function(e) {
    ...
    i && !o.toBlob && (o.toBlob = function(e, t) {
        ...
        this.mozGetAsFile)
            ...
            var i, o = Array.prototype.slice.call(arguments, 1), l = this[s].apply(this, o), c = l.indexOf(","), d = l.substring(c + 1), u = a.test(l.substring(0, c));
            Blob.fake ? ((i = new Blob).encoding = u ? "base64" : "URI",
            i.data = d,
            i.size = d.length) : n && (i = u ? new Blob([r(d)],{
                type: t
...
function() {
        ...
        this.update = function(e) {
            ...
            o)
                if (null !== i[n]) {
                    var x = i[n] || 0
                      , y = o[n];
                    y instanceof Array ? t[n] = g(y, P) : ("string" == typeof y && (y = y.startsWith("+") || y.startsWith("-") ? x + parseFloat(y, 10) : parseFloat(y, 10)),
                    "number" == typeof y && (t[n] = x + (y - x) * P))
                }
            if (null !== b && b.call(t, P),
            1 === c) {
                if (r > 0) {
                    for (n in isFinite(r) && r--,
                    a) {
                        if ("string" == typeof o[n] && (a[n] = a[n] + parseFloat(o[n], 10)),
                        l) {
                            var C = a[n];
                            a[n] = o[n],
                            o[n] = C
    ...
    n.Interpolation = {
        ...
        Bezier: function(e, t) {
            for (var i = 0, o = e.length - 1, a = Math.pow, s = n.Interpolation.Utils.Bernstein, r = 0; r <= o; r++)
...
var ThumbList = function() {
    ...
    e.prototype._renderChunk = function(e, t) {
        ...
        if (n || t != o || 0 != this.needReset) {
            ...
            r = l; r < c; r++)
                s ? e.appendChild(this.createRow(r)) : e.insertBefore(this.createRow(r), e.childNodes[1 + r - l]),
            ...
            t) {
                for (var i = document.createDocumentFragment(), o = [{
                    ...
                    for (var s = o.shift(), r = s.custom, l = 0, c = s.items.length; l < c; l++) {
                        ...
                        if (null == d.custom && null != r && (d.custom = r),
                        this._bindLink(h, d),
...
DFLIP.Share = function(e) {
    function t(t, n) {
        ...
        i.mail = e("<a>", {
            ...
            e(this).attr("href", "mailto:?subject=" + n.text.mailSubject + "&body=" + n.text.mailBody.replace("{{url}}", encodeURIComponent(i.shareUrl))),
            t.stopPropagation()
        }
        )),
    ...
    return e.prototype = {
        ...
        navigateTo: function(e) {
            var t, n = "", i = this, o = function(t) {
                ...
                a ? (i.pdfViewer.contentProvider.options.pageSize == DFLIP.PAGE_SIZE.DOUBLEINTERNAL && a > 2 && (a = 2 * a - 1),
        ...
        customNavigateTo: function(e) {
            if ("" != e && null != e && "null" != e) {
                ...
                if (isNaN(Math.round(e))) {
                    ...
                    isNaN(t)))
                        return void window.open(e, DFLIP.defaults.linkTarget == DFLIP.LINK_TARGET.SELF ? "_self" : "_blank")
                } else
                    t = e;
        ...
        setHash: function(e) {
            if (e.indexOf("=") >= 0) {
                ...
                if ("nameddest"in i)
                    return this.pdfHistory && this.pdfHistory.updateNextHashParam(i.nameddest),
                    void this.navigateTo(i.nameddest);
                if ("page"in i && (t = 0 | i.page || 1),
                "zoom"in i) {
                    var o = i.zoom.split(",")
                      , a = o[0]
                      , s = parseFloat(a);
                    -1 === a.indexOf("Fit") ? n = [null, {
                        name: "XYZ"
                ...
                if (n ? this.pdfViewer.scrollPageIntoView(t || this.page, n) : t && (this.page = t),
                "pagemode"in i) {
    ...
    return e.prototype = {
        ...
        _prepareMatches: function(e, t, n) {
            function i(e, t) {
                ...
                for (var a = t - 1; a >= 0; a--)
                    if (!(i = e[a]).skipped) {
                        if (i.match + i.matchLength < n.match)
                            break;
            ...
            o = 0,
            a = e.length; o < a; o++)
                i(e, o) || (t.push(e[o].match),
                n.push(e[o].matchLength))
        },
        calcFindPhraseMatch: function(e, t, n) {
            for (var i = [], o = e.length, a = -o; -1 !== (a = n.indexOf(e, a + o)); )
                i.push(a);
        ...
        calcFindMatch: function(e) {
            ...
            0 !== n.length && (i || (t = t.toLowerCase(),
            n = n.toLowerCase()),
            o ? this.calcFindPhraseMatch(n, e, t) : this.calcFindWordMatch(n, e, t),
            this.updatePage(e),
            this.resumePageIdx === e && (this.resumePageIdx = null,
            this.nextPageMatch()),
            this.pageMatches[e].length > 0 && (this.matchCount += this.pageMatches[e].length,
        ...
        extractText: function() {
            if (!this.startedTextExtraction) {
                ...
                for (var e = [], t = this.pdfViewer.contentProvider.pdfDocument.numPages, n = 0; n < t; n++)
                    this.extractTextPromises.push(new Promise((function(t) {
                        e.push(t)
                    }
                    )));
                var i = this;
        ...
        executeCommand: function(e, t) {
            ...
            this.firstPagePromise.then(function() {
                ...
                "find" === e ? this.findTimeout = setTimeout(this.nextMatch.bind(this), 250) : this.nextMatch()
            }
            .bind(this))
        },
        ...
        nextMatch: function() {
            ...
            this.dirtyMatch) {
                ...
                for (var i = this, o = 0; o < n; o++)
                    this.updatePage(o),
                    o in this.pendingFindMatches || (this.pendingFindMatches[o] = !0,
        ...
        matchesReady: function(e) {
            ...
            return n ? (this.hadMatch = !0,
            t.matchIdx = i ? n - 1 : 0,
            this.updateMatch(!0),
            !0) : (this.advanceOffsetPage(i),
            !!(t.wrapped && (t.matchIdx = null,
            this.pagesToSearch < 0)) && (this.updateMatch(!1),
            !0))
        },
            ...
            if (0 !== e.length) {
                ...
                for (var d = l; d < c; d++) {
                    var u = e[d]
                      ...
                      , p = u.end
                      , g = a && d === s ? " selected" : "";
                    if (this.findController && this.findController.updateMatchPosition(o, d, n, h.divIdx),
                    i && h.divIdx === i.divIdx ? b(i.divIdx, i.offset, h.offset) : (null !== i && b(i.divIdx, i.offset, r.offset),
                    v(h)),
                    h.divIdx === p.divIdx)
            ...
            if (this.renderingDone) {
                for (var e, t, n = this.matches, i = this.textDivs, o = this.textContent.items, a = -1, s = 0, r = n.length; s < r; s++) {
                    for (var l = n[s], c = Math.max(a, l.begin.divIdx), d = l.end.divIdx; c <= d; c++) {
                        var u = i[c];
                        u.textContent = o[c].str,
                        u.className = ""
                    }
                    a = l.end.divIdx + 1
                }
                if (null !== this.findController && this.findController.active)
                    null !== this.findController && (e = this.findController.pageMatches[this.pageIdx] || null,
                    t = this.findController.pageMatchesLength && this.findController.pageMatchesLength[this.pageIdx] || null),
...
DFLIP.parseLinks = function(e) {
    ...
    if (null != e && e.length > 0)
        for (var n = 0; n < e.length; n++)
            null != (t = e[n]) && null != t[0] && null == t[0].dest && (t = DFLIP.ConvertPageLinks.apply(this, t),
            e[n] = t);
    return e
}
,
function(e) {
        ...
        e("._df_button, ._df_thumb, ._df_custom, ._df_book").each((function() {
            ...
            if ("true" !== (t.attr("parsed") || t.attr("df-parsed")))
                ...
                t.hasClass("_df_book")) {
                    ...
                    null != r && "" != r.toString().trim() ? "img" == l ? (a.append('<img src="' + r + '" alt="' + s + '"/>'),
    ...
    e(document).ready((function() {
        "undefined" == typeof dFlipLocation && 0 != DFLIP.autoDetectLocation && e("script").each((function() {
            var t = e(this)[0].src;
        ...
        "undefined" != typeof dFlipLocation && (dFlipLocation.length > 2 && "/" !== dFlipLocation.slice(-1) && (window.dFlipLocation += "/"),
        ...
        "undefined" != typeof dFlipWPGlobal && (void 0 !== dFlipWPGlobal.pdfVersion && "default" !== dFlipWPGlobal.pdfVersion && (DFLIP.defaults.pdfjsSrc = dFlipLocation + "js/libs/pdfjs/" + dFlipWPGlobal.pdfVersion + "/pdf.min.js",
        ...
        var t = !1;
        if (Array.prototype.forEach.call(DFLIP.utils.getSharePrefixes(), (function(n) {
            if (DFLIP.preParseHash && DFLIP.preParseHash.indexOf(n) >= 0 && !1 === t) {
                var i, o = DFLIP.preParseHash.split(n)[1].split("/")[0], a = DFLIP.preParseHash.split(n)[1].split("/")[1];
                null != a && (a = a.split("/")[0]),
                0 == (i = e("[slug=" + o + "]")).length && (i = e("#" + o)),
                0 == i.length && (i = e("[_slug=" + o + "]")),
                i.length > 0 && (null != a && i.data("page", a),
                i.is("._df_button, ._df_thumb, ._df_custom") && (i.trigger("click"),
                t = !0))
            }
        }
        )),

/*======================================================================
Plugins: jQuery Easing, jQuery Marquee, jQuery Cookie, Access Script, Dropdown Menu, Custom Selectbox, Responsive Tabs, Images Loaded, LiteBox, jQuery UI, Multiple Ticker, Swiper, Magnific Popup
======================================================================*/
...
// Access Script
/*var siteName=$("#hdnSiteName").val();akCookie={create:function(c,d,e){var b="";if(e){var a=new Date;a.setTime(a.getTime()+e*24*60*60*1000);b="; expires="+a.toGMTString()}document.cookie=c+"="+d+b+"; path=/"},read:function(b){var e=b+"=";var a=document.cookie.split(";");for(var d=0;d<a.length;d++){var f=a[d];while(f.charAt(0)==" "){f=f.substring(1,f.length)}if(f.indexOf(e)==0){return f.substring(e.length,f.length)}}return null},erase:function(a){akCookie.create(a,"",-1)}};$(function(){$("#accessControl").show();akAccess=function(){var e={normal:"93.8%",large:"100%",larger:"106.3%"};var d=["normal","wob","dGreenTheme","blueTheme","greenTheme"];var f;var h;var g=akCookie.read(siteName);if(g!==null){settings=g.split(" ");b(settings[0]);a(settings[1])}else{$("input.font-large").addClass("current");$("input.contrast-normal").addClass("current")}function b(i){$("body").css("font-size",e[i]);for(key in e){if(i===key){f=key}}if(!f){f="large"}$(".fontScaler").removeClass("current");$(".font-"+f).addClass("current")}function a(i){h=i;$("body").removeClass(d.join(" "));$("body").addClass(i);$("input.contrastChanger").each(function(){$(this).removeClass("current")});$("input.contrast-"+h).addClass("current")}function c(){akCookie.create(siteName,f+" "+h,2)}return{handleFontSizeEvent:function(i){var j=i.split("_")[i.split("_").length-1];b(j);c();return false},handleContrastEvent:function(i){var j=i.split("_")[i.split("_").length-1];a(j);c();return false}}}();$("#accessControl input.fontScaler").click(function(){akAccess.handleFontSizeEvent($(this).attr("id"));$("#accessControl input.fontScaler").each(function(){$(this).removeClass("current")});$(this).addClass("current");return false});$("#accessControl input.contrastChanger").click(function(){akAccess.handleContrastEvent($(this).attr("id"));return false})});*/
...
function buildmenu() {
    var $mainmenu = jQuery("#mainNav ul") && jQuery("#nav li");
    var $headers = $mainmenu.find("ul").parent();
    jQuery($headers).hover(function(e) {
        jQuery(this).children("a:eq(0)").addClass("selected");
        jQuery("#nav li").removeClass("focus")
    }, function(e) {
...
var adjustMenu = function() {
    if (jQuery('body').hasClass('device')) {
        ...
        jQuery("#navMob li.parent .menuIcon").unbind("click").bind("click", function(e) {
            e.preventDefault();
            ...
            if (jQuery(this).hasClass("active")) {
                ...
                var navtop = jQuery('.toggleMenu').offset();

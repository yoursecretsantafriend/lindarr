...
;(function ($, window, document, undefined) {
    ...
    function EasyTicker(el, options) {
        ...
        function startForce(){
            ...
            $(s.opts.controls.toggle1).addClass('et-run1').html(s.opts.controls.stopText); 
            $(s.opts.controls.toggle2).addClass('et-run2').html(s.opts.controls.stopText); 
            $(s.opts.controls.toggle3).addClass('et-run3').html(s.opts.controls.stopText); 
        ...
        function stop(){
            ...
            $(s.opts.controls.toggle1).removeClass('et-run1').html(s.opts.controls.playText);
            $(s.opts.controls.toggle2).removeClass('et-run2').html(s.opts.controls.playText);
            $(s.opts.controls.toggle3).removeClass('et-run3').html(s.opts.controls.playText);
        }
